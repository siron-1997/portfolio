...
/* セクション カメラパラメーター */
export const getSectionsCameraParams = (cameraConfigsData, width) => {
    const cameraParams = {
        pageHeader: { position: null, rotation: null },
        introduction: { position: null, rotation: null },
        controls: { position: null, rotation: null }
    }
...
/* ビュワーモード カメラパラメーター */
export const getViwerToggleCameraParams = (cameraConfigsData, width) => {
    const cameraParams = { position: null, rotation: null }
    let zoom = 0
...
export const getControlsCameraParams = (currentCameraParams, width) => {
    const cameraParams = { position: null, rotation: null }
