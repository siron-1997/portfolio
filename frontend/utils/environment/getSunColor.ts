...
const setCurrentWeatherColor = (currentWeather: any, timePointColor: WeatherColor) => {
    let color: string = ''
...
const getSunLightColor = (currentWeather: any, timePoint: 'evening' | 'night' | 'lunch') => {
    let sunLightColor: string = ''
...
export default getSunLightColor