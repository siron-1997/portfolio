...
const pointLightsAnimation = (pointLightsRef: any, pointLightsData: any) => {
    const ctx = gsap.context(() => {
        pointLightsRef.current.children.forEach((light: any, i: number) => {
...
export default pointLightsAnimation