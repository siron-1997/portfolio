...
export default function Clouds({ cloudsAll, currentWeathers, timePoint }) {
    ...
    const clouds = {
        thin: { // 薄雲
            ...
            position: width > BREAK_POINT_MB ? [ 0, - 0.5, - 41 ] : [ - 5, 18, 10 ], // デバイスに応じて位置を切り替え
            rotation: width > BREAK_POINT_MB ? [ MathUtils.degToRad(75), 0, 0 ] : [ MathUtils.degToRad(55), 0, MathUtils.degToRad(180) ] // デバイスに応じて角度を切り替え
        },
        thick: { // 厚雲
            texture: useTexture(
